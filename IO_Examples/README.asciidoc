...
Simple example that configures P0_0 as output and toggles it within the endless loop. The measurement below using the RleaxKit Eval board reveals a period of approximately 150ns.
